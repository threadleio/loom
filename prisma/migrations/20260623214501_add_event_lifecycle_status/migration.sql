...
INSERT INTO "new_Event" ("accessCode", "createdAt", "createdBy", "endDate", "id", "moderationEnabled", "name", "passcode", "startDate") SELECT "accessCode", "createdAt", "createdBy", "endDate", "id", "moderationEnabled", "name", "passcode", "startDate" FROM "Event";
DROP TABLE "Event";
